...
class Report:
    def __init__(self, years_salary, years_vacs_count, prof_years_salary, prof_years_vacs_count, city_salary, city_vacs_rate):
    ...
    def generate_excel(self):
        ...
        for index, keys in enumerate(self.city_salary.keys()):
            city_sheet.append([keys, self.city_salary[keys], None, list(self.city_vacs_rate.keys())[index], self.city_vacs_rate[list(self.city_vacs_rate.keys())[index]]])
...
Report(years_salary, years_vacs_count, prof_years_salary, prof_years_vacs_count, city_salary, city_vacs_rate).generate_excel()
